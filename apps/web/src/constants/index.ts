...
export const UI_CONSTANTS = {
  ...
  ERROR_MESSAGES: {
    ...
    VALIDATION: {
      ...
      PREREQUISITES_REQUIRED: 'Prerequisites are required',
      PREREQUISITES_MIN_LENGTH: 'Prerequisites must be at least 10 characters long',
      PREREQUISITES_MAX_LENGTH: 'Prerequisites must be less than 1000 characters',
